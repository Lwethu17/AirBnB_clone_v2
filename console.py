...
class HBNBCommand(cmd.Cmd):
    """ Contains all the functionality for the HolbertonBNB console"""
    ...
    def precmd(self, line):
        ...
        try:  # parses the line left to right
            ...
            # if parentheses contains the arguments, parse them
    ...
    def do_quit(self, command):
        """ Method to exit the HolbertonBNB console"""
        exit(0)
